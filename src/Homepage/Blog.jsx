...
const Blog = () => {
  ...
  return (
    ...
    <div >
      <h2 className="text-3xl lg:text-5xl font-semibold mb-5 text-center">
        Blog
      </h2>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3  gap-5 container  mx-auto mb-24">
    {
      blogData?.map(
        ...
        <div className="card  bg-white shadow-xl shadow-blue-500/50 ">
          <div className="card-body text-gray-600 ">
            ...
            <button className="btn text-xl bg-blue-400 shadow-lg shadow-blue-500/50" onClick={() => window.blog.id.showModal()}>See More</button>
          


            <dialog id={blog.id} className="modal">
